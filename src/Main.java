...
public class Main {
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < listLines.size(); i++){
			...
			//String stringToAnalyze = listDictionary.get(i).toString();
			//String stringToAnalyze = listLines.get(i);
			
			//System.out.println("Analyse du mot " + stringToAnalyze);
					//(String)listLines.toArray()[i];
			EstUnAnagrammeEfficace(listLines.get(i));
		...
		for(int i = 0; i < listDictionary.size();++i){
			...
			char[] chaineArray = listDictionary.get(i).toCharArray();
			...
			System.out.println("Il y a " + anagramMap.get(dictionaryKey) + " anagrammes du mot " + listDictionary.get(i));

		}
		long endTime = System.nanoTime();
		
		System.out.println("The whole program took "+(endTime - startTime) + " ns"); 
	}
